...
* @returns {any}
*/
export function newOcs() {
    const ret = wasm.newOcs();
...
* @returns {Uint32Array}
*/
export function arrange(ocs, duration) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.arrange(retptr, addHeapObject(ocs), duration);
...
* @returns {any}
*/
export function newGenSqlData() {
    const ret = wasm.newGenSqlData();
    return takeObject(ret);
}

/**
* @param {any} create_data
* @returns {any}
*/
export function genSqls(create_data) {
    const ret = wasm.genSqls(addHeapObject(create_data));
    return takeObject(ret);
}
